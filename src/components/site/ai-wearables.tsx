          ...
          <ol className="relative ml-2 border-l border-white/10 pl-8">
            {timeline.map((t, i) => (
              ...
              >
                ...
                <div className="flex items-baseline gap-3 text-[11px] uppercase tracking-[0.22em] text-foreground/45">
                ...
                <p className="mt-2 max-w-xl text-pretty text-[15px] leading-relaxed text-foreground/60">
                  {t.blurb}
                </p>
                <div className="mt-3 flex flex-wrap gap-2">
                  {t.chips.map((c) => (
                    <span
                      key={c}
                      className="inline-flex rounded-full border border-white/10 bg-white/[0.03] px-2.5 py-1 text-[11px] text-foreground/70"
                    >
                      {c}
                    </span>
                  ))}
          ...
          <div className="sticky top-32 space-y-4">
            ...
            {pillars.map((p, i) => (
              <Reveal key={p.title} delay={0.1 + i * 0.08}>
                <div className="group relative overflow-hidden rounded-2xl border border-white/8 bg-white/[0.02] p-5 backdrop-blur-sm transition-colors hover:border-white/15">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="mt-1 h-2 w-2 rounded-full bg-white/80 shadow-[0_0_10px_rgba(255,255,255,0.7)]" />
                    <div>
